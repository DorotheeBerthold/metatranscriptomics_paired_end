#!/bin/bash
#SBATCH --job-name=annotate_rRNA
#SBATCH --output=annotate_rRNA_%A_%a.log
...
FILES=($(ls ${READ_DIR}/*_R1_unique_rRNA.fastq))
...
SAMPLE=${BASENAME%_R1_unique_rRNA.fastq}
...
# -------- OUTPUT DIRS --------
OUTDIR="annotation_results_rRNA/${SAMPLE}"
mkdir -p ${OUTDIR}
